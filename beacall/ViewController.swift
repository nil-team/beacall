...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // let region = CLBeaconRegion(proximityUUID: UUID(uuidString:"F2A74FC4-7625-44DB-9B08-CB7E130B2029")!, identifier: "uBeacon")
        // f7826da6-4fa2-4e98-8024-bc5b71e0893e
        
        // f2a74fc4-7625-44db-9b08-cb7e130b2029
        // e16e8a8e-34ec-4326-b21e-9b35f22f405b
        
        let brognart = CLCircularRegion(center: CLLocationCoordinate2D(latitude: 48.869404, longitude: 2.341428), radius: 500, identifier: "school")
